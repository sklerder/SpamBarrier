...
'Search_description'				=>	'This function allows you to search for users with an URL in the signature and having never posted. This could help to find spammers who have succeeded in passsing through "SpamBarrier" checks. <br />Search results will be limited to the latest 50 registered users meeting these criteria.',
'Go!'						=>	'Go!',
'No_match'					=>	'No match.',
'Display stats'             =>  'Display the stats',
'Stats explanation'         =>  'This function is very time-consuming (several seconds per hundred thousand records in the database). <br />It displays "SpamBarrier" statistics on the whole records in the database.',
'Registration_stats'		=>	'Registration statistics',
'Display the statistics'    =>  'Calculate and display',
